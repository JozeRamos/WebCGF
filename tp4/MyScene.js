...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.unitCubeQuad = new MyUnitCubeQuad(this, this.texture5, this.texture6, this.texture6, this.texture6, this.texture6, this.texture7);
      }
    ...
    display() {
        ...
        if (this.quadShow) this.quad.display();
