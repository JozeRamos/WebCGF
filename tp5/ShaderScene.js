...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.texFeup = new CGFtexture(this, "textures/FEUP.jpg");
		this.texWaterTex = new CGFtexture(this, "textures/waterTex.jpg");
		this.texWaterMap = new CGFtexture(this, "textures/waterMap.jpg");
		this.appearance.setTexture(this.texWaterTex);
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/translationX.vert", "shaders/translationX.frag"),
	...
	display() {
		...
		if (this.selectedObject==0) {
			...
			// First photo of teapot
			//this.rotate(-Math.PI / 2, 1, 0, 0); 

			// Second photo of teapot
