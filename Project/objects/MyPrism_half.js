 ...
 * @param slices - Reference to MyPrism_half number of slices (bigger number will be more detailled)
 * @param stacks - Reference to MyPrism_half number of stacks (bigger number will be more detailled)
 */
export class MyPrism_half extends CGFobject {
